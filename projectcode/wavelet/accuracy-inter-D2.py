...
########Z001 to Z009######
for i in range(1, 10):
    #with open('/Users/jingli/Desktop/EpEEG/F/F00'+ str(i) +'.txt','r') as csvfile:
    with open('/Users/jingli/Desktop/EpEEG/N/N00'+ str(i) +'.txt','r') as csvfile:
...
for i in range(10, 51):
    #with open('/Users/jingli/Desktop/EpEEG/F/F0'+ str(i) +'.txt','r') as csvfile:
    with open('/Users/jingli/Desktop/EpEEG/N/N0'+ str(i) +'.txt','r') as csvfile:
        plots = csv.reader(csvfile, delimiter=',')
        for row in plots:
            x.append(float(row[0]))
'''
...
###########100#################
#with open('/Users/jingli/Desktop/EpEEG/N/N100.txt','r') as csvfile:
with open('/Users/jingli/Desktop/EpEEG/F/F100.txt','r') as csvfile:
    plots = csv.reader(csvfile, delimiter=',')
    for row in plots:
        x.append(float(row[0]))
...
threshold =   1.444 #1.5088972694685967 #1.339989609821938 #1.5088972694685967 1.5136381197955173
count = 0
